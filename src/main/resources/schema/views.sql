...
UNION ALL
SELECT 'ASSETS00_INTERNALKEY' CODE, 'AAUCI' VALUE, 'A/A' DESCR FROM DUAL
UNION ALL
SELECT 'ASSETS00_INTERNALKEY' CODE, 'ASSFILE' VALUE, 'Assignement File' DESCR FROM DUAL
UNION ALL
SELECT 'ASSETS00_INTERNALKEY' CODE, 'UNIQCODE' VALUE, 'Unique Code' DESCR FROM DUAL
UNION ALL
SELECT 'ASSETS00_INTERNALKEY' CODE, 'DOV' VALUE, 'Doovalue Portfolio' DESCR FROM DUAL
UNION ALL
SELECT 'ASSETS00_INTERNALKEY' CODE, 'B2CAPITAL' VALUE, 'B2Kapital Portfolio' DESCR FROM DUAL
UNION ALL
...
SELECT  'ASSETS_VALUE' CODE, 'EXTRA_FLD1'                 VALUE,  'EXTRA FLD1' DESCR FROM DUAL UNION ALL
SELECT  'ASSETS_VALUE' CODE, 'EXTRA_FLD2'                 VALUE,  'EXTRA FLD2' DESCR FROM DUAL UNION ALL
SELECT  'ASSETS_VALUE' CODE, 'EXTRA_FLD3'                 VALUE,  'EXTRA FLD3' DESCR FROM DUAL UNION ALL
SELECT  'CRM_SERVER_URL' CODE, 'CRM_SERVER_URL_1' VALUE, 'http://ucitest.ddns.net:8081/OPSWTESTWEBSERV/uci/propertiesxml' VALUE1, 'Descr' DESCR FROM DUAL
) consts;
