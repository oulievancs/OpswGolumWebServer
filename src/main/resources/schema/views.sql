...
SELECT  'ASSETS_VALUE' CODE, 'CALLATERAL'                FIELD,  'Collateral Use 1' VALUE FROM DUAL UNION ALL
...
SELECT  'CRM_SERVER_URL' CODE, 'CRM_SERVER_URL_1' FIELD, 'http://ucitest.ddns.net:8081/OPSWTESTWEBSERV/uci/propertiesxml' VALUE1, 'Descr' VALUE FROM DUAL
) consts;
