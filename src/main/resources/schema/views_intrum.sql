...
UNION ALL
SELECT 'ASSETS00_INTERNALKEY' CODE, 'INTRAUCT' FIELD, 'Intrum Auctions' VALUE FROM DUAL
UNION ALL
SELECT 'ASSETS00_INTERNALKEY' CODE, 'INTRRET' FIELD, 'Intrum Retail' VALUE FROM DUAL
UNION ALL
...
SELECT  'ASSETS_VALUE' CODE, 'HIGH_INTEREST'                 FIELD,  'Landea High Interest' VALUE FROM DUAL UNION ALL
...
--*********************************************************************************************************
SELECT  'ASSETS_VALUE' CODE, 'TOTAL_HIGH_INTEREST'                 FIELD,  'Total High Interest' VALUE FROM DUAL UNION ALL
SELECT  'ASSETS_VALUE' CODE, 'TOTAL_LEADS'                 FIELD,  'Total Leads' VALUE FROM DUAL UNION ALL
SELECT  'ASSETS_VALUE' CODE, 'TOTAL_OPPORTUNITY'                 FIELD,  'Oportunities' VALUE FROM DUAL UNION ALL
SELECT  'ASSETS_VALUE' CODE, 'PROSFORA_A'                  FIELD, 'Offer A' VALUE FROM DUAL UNION ALL
SELECT  'ASSETS_VALUE' CODE, 'PROSFORA_A_TOTAL'                  FIELD, 'Offer A Total' VALUE FROM DUAL UNION ALL
SELECT  'ASSETS_VALUE' CODE, 'AFM'                  FIELD, 'Taxpayer ID' VALUE FROM DUAL UNION ALL
SELECT  'ASSETS_VALUE' CODE, 'PRESENTATION'                  FIELD, 'Presentation' VALUE FROM DUAL UNION ALL
SELECT  'ASSETS_VALUE' CODE, 'KODIKOS_SDA'                  FIELD, 'SDA Code' VALUE FROM DUAL UNION ALL
--*********************************************************************************************************
...
SELECT  'ASSETS_VALUE' CODE, 'OPPORTUNITY'                 FIELD,  'Landea Opportunities' VALUE FROM DUAL UNION ALL
