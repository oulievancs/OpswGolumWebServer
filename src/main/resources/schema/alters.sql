...
ALTER TABLE `ASSETS00` MODIFY COLUMN `DESCRIPTION` VARCHAR(3000) NULL DEFAULT NULL;
...
ALTER TABLE `ASSETS00` MODIFY COLUMN `CUSTOMER_FILE` VARCHAR(200) NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` ADD COLUMN `REMARKS` VARCHAR(100) NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` ADD COLUMN `REMARKS` VARCHAR(200) NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` ADD COLUMN `OPPORTUNITY` INT(5) NULL DEFAULT NULL;

ALTER TABLE `ASSETS00` ADD COLUMN `TOTAL_LEADS` INT(5) NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` ADD COLUMN `TOTAL_HIGH_INTEREST` INT(5) NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` ADD COLUMN `TOTAL_OPPORTUNITY` INT(5) NULL DEFAULT NULL;

ALTER TABLE `ASSETS00` ADD COLUMN `PROSFORA_A` DOUBLE NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` ADD COLUMN `PROSFORA_A_TOTAL` DOUBLE NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` ADD COLUMN `KODIKOS_SDA` VARCHAR(50) NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` MODIFY COLUMN `KODIKOS_SDA` VARCHAR(100) NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` ADD COLUMN `AFM` VARCHAR(20) NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` MODIFY COLUMN `AFM` VARCHAR(50) NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` ADD COLUMN `PRESENTATION` INT(1) NULL DEFAULT NULL;

ALTER TABLE `ASSETS00` DROP COLUMN `SITE`;
ALTER TABLE `ASSETS00` MODIFY COLUMN `COMMENTS1` VARCHAR(400) NULL DEFAULT NULL;

ALTER TABLE `ASSETS00` ADD COLUMN `SOLD_PRICE` DOUBLE NULL DEFAULT NULL;

ALTER TABLE `ASSETS00` DROP COLUMN `UNIQUEAUCTION_CODE`;

ALTER TABLE `ASSETS00` MODIFY COLUMN `OWNERSHIP_TYPE` VARCHAR(50) NULL DEFAULT NULL;
