...
ALTER TABLE `ASSETS00` ADD COLUMN `BUYER_CEPAL` VARCHAR(100) NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` ADD COLUMN `OPINION_ONVALUE` VARCHAR(100) NULL DEFAULT NULL;
ALTER TABLE `ASSETS00` DROP COLUMN `SEND_INVESTORS`; 
...
ALTER TABLE `ASSETS00` ADD COLUMN `OPPORTUNITY` VARCHAR(100) NULL DEFAULT NULL;
