...
SELECT  'ASSETS_VALUE' CODE, 'COMMENTS2'           VALUE,  'ΣΧΟΛΙΑ Ι' DESCR FROM DUAL UNION ALL
SELECT  'ASSETS_VALUE' CODE, 'COMMENTS1'                 VALUE,  'ΣΧΟΛΙΑ ΙΙ' DESCR FROM DUAL UNION ALL
