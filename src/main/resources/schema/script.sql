...
CREATE TABLE IF NOT EXISTS `OPSWDB`.`ASSETS00` (
  ...
  `AUCTIONURL` VARCHAR(100) NULL DEFAULT NULL,
  ...
  `BORRNAME` VARCHAR(50) NULL DEFAULT NULL,
  ...
  `AUCTION_ID` VARCHAR(50) NULL DEFAULT NULL,
  ...
  `BROKER_SITE` VARCHAR(100) NULL DEFAULT NULL,
  `SUBBROKER_NAME` VARCHAR(60) NULL DEFAULT NULL,
  `VISITORS_COUNT` INT(10) NULL DEFAULT NULL,
  `BEGIN_ENDIAFERON` INT(1) NULL DEFAULT NULL,
  `LEADS` INT(10) NULL DEFAULT NULL,
  `ENDIAFEROMENOS_INFO` VARCHAR(60) NULL DEFAULT NULL,
  `ENDIAFEROMENOS_INFO1` VARCHAR(60) NULL DEFAULT NULL,
  `ENDIAFEROMENOS_INFO2` VARCHAR(60) NULL DEFAULT NULL,
  `ENDIAFEROMENOS_INFO3` VARCHAR(60) NULL DEFAULT NULL,
  `ENDIAFEROMENOS_INFO4` VARCHAR(60) NULL DEFAULT NULL,
  `ENDIAFEROMENOS_INFO5` VARCHAR(60) NULL DEFAULT NULL,
  `COMMENTS1` VARCHAR(200) NULL DEFAULT NULL,
  `COMMENTS2` VARCHAR(200) NULL DEFAULT NULL,
  `MARKETABILITY_NAME` INT(5) NULL DEFAULT NULL,
  ...
  `HIGH_INTEREST` VARCHAR(60) NULL DEFAULT NULL,
...
CREATE INDEX `fk_ASSETS00_SYMB_1` ON `OPSWDB`.`ASSETS00` (`SYMB_ID` ASC);


-- -----------------------------------------------------
-- Table `OPSWDB`.`ASSETS00FL`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPSWDB`.`ASSETS00FL` ;
...
CREATE TABLE IF NOT EXISTS `OPSWDB`.`GRAM01` (
  ...
  `DATE_FORMAT` VARCHAR(3) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `OPSWDB`.`UCIREMSERVREQ` ;
